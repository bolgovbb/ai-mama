  ...
  return (
    <html lang="ru">
      <head>
        ...
        {/* Search Console / Webmaster verification — replace with real
            codes from https://webmaster.yandex.ru and Google Search Console */}
